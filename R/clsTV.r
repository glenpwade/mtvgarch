...
setGeneric(name="tv",
           function(st="numeric",shape="numeric")standardGeneric("tv"),
           valueClass = "tv_class",
...
setGeneric(name=".estimateTV",
           function(e="numeric",tv="tv_class",estimationControl="list")standardGeneric(".estimateTV"),
           valueClass = "tv_class",
...
setGeneric(name="LM.TR2",
           function(e="numeric",tvobj="tv_class")standardGeneric("LM.TR2"),
           valueClass = "numeric",
           signature = c("e","tvobj")
)
...
setGeneric(name="LM.Robust",
           function(e="numeric",tvobj="tv_class")standardGeneric("LM.Robust"),
           valueClass = "numeric",
           signature = c("e","tvobj")
)
...
setGeneric(name="setTaylorOrder",
           function(taylor.order="numeric",tvobj="tv_class")standardGeneric("setTaylorOrder"),
           valueClass = "tv_class",
           signature = c("taylor.order","tvobj")
)
setMethod("setTaylorOrder",signature = c("numeric","tv_class"),
          function(taylor.order,tvobj){
            this <- tvobj
...
setGeneric(name=".testStatDist",
           function(tvobj="tv_class",refdata="matrix",reftests="list",simcontrol="list")standardGeneric(".testStatDist"),
           valueClass = "list",
...
setMethod("testStatDist",signature = c("tv_class","matrix","list","missing"),
          function(tvobj,refdata,reftests){
            ...
            simcontrol$numCores <- detectCores() - 1
            .testStatDist(tvobj,refdata,reftests,simcontrol)
          })
...
setGeneric(name=".SetInitialPars",
           function(tv="tv_class")standardGeneric(".SetInitialPars"),
           valueClass = "tv_class",
           signature = c("tv")
)
...
setGeneric(name=".EstimatedParsToMatrix",
           function(tv="tv_class",optimpars="numeric")standardGeneric(".EstimatedParsToMatrix"),
           valueClass = "tv_class",
           signature = c("tv","optimpars")
)

setMethod(".EstimatedParsToMatrix",signature = c("tv_class","numeric"),
          function(tv,optimpars){
            this <- tv
...
setGeneric(name=".dg_dt",
           function(tvobj="tv_class")standardGeneric(".dg_dt"),
           valueClass = "matrix",
           signature = c("tvobj")
)
...
setGeneric(name=".dg_dt2",
           function(st="numeric")standardGeneric(".dg_dt2"),
           valueClass = "matrix",
           signature = c("st")
)
...
setGeneric(name=".calculate_g",
           function(tvobj="tv_class")standardGeneric(".calculate_g"),
           valueClass = "numeric",
           signature = c("tvobj")
)
...
setGeneric(name=".loglik.tv.univar",
           function(optimpars="numeric",e="numeric",tvobj="tv_class")standardGeneric(".loglik.tv.univar"),
           valueClass = "numeric",
           signature = c("optimpars","e","tvobj")
)

setMethod(".loglik.tv.univar",signature = c("numeric","numeric","tv_class"),
          function(optimpars,e,tvobj){
