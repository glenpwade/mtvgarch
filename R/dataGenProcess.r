...
## -- calc.Gt.eta(spd,loc,Tobs) -- ##
...

 {
   ...
   # starting from t=2! (set Qt[1]=Q1)
   Qt_1 <- Q1
   Gt <- rbind(matrix(0,nrow=discard,ncol=1),calc.Gt.eta(speed,loc,nr.obs)) # st=timetrend, loc=0.5, gamma s.t. transition takes place between 0.25 and 0.75 of the sample
